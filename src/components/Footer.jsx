    ...
    <footer className="bg-gray-800 text-white py-10 mt-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/aboutus" className="text-gray-400 hover:text-gray-200">About Us</a>
              </li>
              <li>
                <a href="/contactus" className="text-gray-400 hover:text-gray-200">Contact Us</a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-4 text-sm text-gray-400 text-center">
          &copy; {new Date().getFullYear()} PSSKVP. All rights reserved.
        </div>
      </div>
    </footer>
  );
